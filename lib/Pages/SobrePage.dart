              ...
              child: Column(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(top: 10),
                        child: Text('Ez Vistorias', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 23))
                    ),
                    Text('A solução completa para simplificar suas vistorias de imóveis', style: TextStyle(fontSize: 20), textAlign: TextAlign.center),
                    Padding(padding: EdgeInsets.only(top: 75),
                        child: Column(
                          children: [
                            Text('Desenvolvido por:', style: TextStyle(fontSize: 17)),
